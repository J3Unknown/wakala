              ...
              children: [
                ...
                Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('This is the longest name ever', style: Theme.of(context).textTheme.titleMedium!.copyWith(fontWeight: FontWeight.bold), maxLines: AppSizes.s1, overflow: TextOverflow.ellipsis,),
